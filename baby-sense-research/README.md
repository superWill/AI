...
产品决策见 [`婴儿哭声感知-方案与PRD.md`](婴儿哭声感知-方案与PRD.md)（PRD v0.5）；工程见 [`技术方案.md`](技术方案.md)（v0.3）；**使用闭环**见 [`闭环与建议引擎设计.md`](闭环与建议引擎设计.md)；UX：[`v1-结果页文案与交互.md`](v1-结果页文案与交互.md) · [`v1-页面流原型.md`](v1-页面流原型.md) · [`v2-档案页设计.md`](v2-档案页设计.md)；数据见 [`数据清单.md`](数据清单.md)。
